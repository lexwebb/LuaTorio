...
| [`signal_at_asc.lua`](examples/signal_at_asc.lua) | Min priority among present (`signal_at_asc`) — WarDaft-style rank |
...
| `signal_at_asc(index, a, b, …)` | Value of Nth-smallest nonzero arg; WarDaft priority idiom |
